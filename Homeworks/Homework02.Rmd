...
**a.** Find the five individual flights with the longest delay times in the data. Find the five flights with the shortest delay times in the data. 

**b.** Find the five flight numbers (`tailnum`) with the longest average delay times.

**c.** Identify the total distance and average travel distance within each month.

**d.** Create a new variable, `nighttime`, which is an indicator (TRUE/FALSE) for whether or not the flight took place at 7:00 PM or later (`hour >= 19`), and estimate the average distance and depature delay time within both `nighttime` groups.
